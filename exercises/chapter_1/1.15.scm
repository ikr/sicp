; Q: The sine of an angle (specified in radians) can be computed by making use of the approximation
...
; A:
;
; a. The procedure p is applied exactly 4 times.
;
; b. Order of growth for both space and time is log a.
