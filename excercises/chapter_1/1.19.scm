; Q: There is a clever algorithm for computing the Fibonacci numbers in a logarithmic number of
; steps. Recall the transformation of the state variables a and b in the fib-iter process
; of Section 1.2.2: a ← a + b and b ← a. Call this transformation T, and observe that applying T
...
; transformation Tp′q′ of the same form, and compute p′ and q′ in terms of p and q. This gives us
; an explicit way to square these transformations, and thus we can compute T^n using successive
...
; A: See 1.19.odf (LibreOffice Math file) for Tp′q′ derivation. Now, using that result:
